...
{
    public class NextConstraint : ActivityScopeConstraint
    {
        ...
        {
            Constraint.AddValidationError(context, new ValidationError(Resources.Validation_ScopeErrorFormat(nameof(Iterate))));
        }
    }
}